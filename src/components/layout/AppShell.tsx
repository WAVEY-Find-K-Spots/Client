...
export default function AppShell() {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center gap-14 bg-[#f4e9de] lg:py-8 px-0">
      ...
      <div className="relative z-10 w-full max-w-[440px] min-h-screen lg:min-h-0 lg:max-w-none lg:w-[393px] lg:h-[852px] lg:rounded-[46px] lg:border-[10px] lg:border-ink/90 lg:shadow-2xl overflow-hidden bg-page phone-viewport">
