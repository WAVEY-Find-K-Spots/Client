...
export function KakaoMark({ className }: MarkProps) {
  return (
    <svg viewBox="0 0 256 256" className={className} fill="currentColor" aria-hidden="true">
      <path d="M128 36C70.6 36 24 72.9 24 118.4c0 29.4 19.5 55.2 48.8 69.6-1.6 5.5-10.3 35.6-10.6 38-.5 3 1.1 3 2.3 2.2 1.6-1 41.6-28.3 54.6-37.1 2.9.3 5.9.4 8.9.4 57.4 0 104-36.9 104-82.4S185.4 36 128 36z" />
    </svg>
  );
}
